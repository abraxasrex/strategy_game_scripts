...
public class Harvester : Unit
{
    ...
    protected override void Start()
    {
        ...
        if (!resourceStore)
        {
            SetBuilding(player.GetComponentInChildren<WarFactory>());
        }
    }
    ...
    //{
    //    Debug.Log(creator);
    //    Debug.Log(player.GetComponentInChildren<WarFactory>());
    ...
    //    else
    //    {
    //        resourceStore = getPlayerFactory();
    //    }
    //}
    ...
    public Building getPlayerFactory()
    {
        return player.GetComponentInChildren<WarFactory>();
    }
